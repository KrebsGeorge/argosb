...
```
vlpt="" vmpt="" hypt="" tupt="" xhpt="" anpt="" uuid="" reym="" argo="" agn="" agk="" ip="" bash <(curl -Ls https://raw.githubusercontent.com/KrebsGeorge/argosb/refs/heads/main/argosb.sh)
```
...
```
vlpt="" vmpt="" hypt="" tupt="" xhpt="" anpt="" argo="y" agn="" agk="" bash <(curl -Ls https://raw.githubusercontent.com/KrebsGeorge/argosb/refs/heads/main/argosb.sh)
```
...
```
vmpt="" argo="y" agn="" agk="" bash <(curl -Ls https://raw.githubusercontent.com/KrebsGeorge/argosb/refs/heads/main/argosb.sh)
```
...
```
hypt="" bash <(curl -Ls https://raw.githubusercontent.com/KrebsGeorge/argosb/refs/heads/main/argosb.sh)
```
...
```agsb list``` 或者 ```bash <(curl -Ls https://raw.githubusercontent.com/KrebsGeorge/argosb/refs/heads/main/argosb.sh) list```
...
```ip=4 agsb list```或者```ip=4 bash <(curl -Ls https://raw.githubusercontent.com/KrebsGeorge/argosb/refs/heads/main/argosb.sh) list```

显示IPV6节点配置：

```ip=6 agsb list```或者```ip=6 bash <(curl -Ls https://raw.githubusercontent.com/KrebsGeorge/argosb/refs/heads/main/argosb.sh) list```

 3、卸载脚本：

```agsb del``` 或者 ```bash <(curl -Ls https://raw.githubusercontent.com/KrebsGeorge/argosb/refs/heads/main/argosb.sh) del```
